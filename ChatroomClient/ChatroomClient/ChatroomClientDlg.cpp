...
{
	CDialogEx::DoDataExchange(pDX);
	DDX_Control(pDX, IDC_EDIT4, editIP);
	DDX_Control(pDX, IDC_EDIT3, editPort);
	DDX_Control(pDX, IDC_BUTTON1, buttonConnect);
	DDX_Control(pDX, IDC_EDIT9, editShowChannel);
	DDX_Control(pDX, IDC_EDIT8, editMessage);
	DDX_Control(pDX, IDC_BUTTON3, buttonSend);
}
